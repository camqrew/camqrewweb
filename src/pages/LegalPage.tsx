  ...
  return (
    <div className="legal-page-container">
      <SEOHead 
        ...
        description="Comprehensive Terms of Service, Milestone Escrow Rules, DPDP 2023 Privacy Policy, and Shoot Contracts for Camqrew India."
      />
      ...
      <div className="legal-hero-banner">
        <div className="container">
          ...
          <h1 className="legal-hero-title">Camqrew Terms, Policies & Escrow Protection</h1>
            ...
            <div className="card legal-document-card">
              ...
              {activeSection === 'terms' && (
                <article className="legal-article">
                  ...
                  <section className="legal-section">
                    ...
                    <p>
                      Camqrew operates as an electronic marketplace and communications intermediary under Section 79 of the Information Technology Act, 2000. Camqrew provides an algorithmic discovery engine, verified identity badging, milestone escrow management, and automated shoot contracting to facilitate agreements between independent Creative Specialists (&quot;Creators&quot;) and Clients (&quot;Producers&quot; or &quot;Customers&quot;).
                    </p>
                  </section>
                  ...
                  <section className="legal-section">
                    ...
                    <p>
                      When a Client books a Creator on Camqrew, a legally binding Production Service Agreement is formed directly between the Client and the Creator, governed by the Indian Contract Act, 1872. Camqrew acts as the designated escrow holding agent and neutral arbitrator for milestone releases.
                    </p>
                  </section>
                  ...
                  <section className="legal-section">
                    ...
                    <p>
                      Camqrew charges a nominal 2.5% platform technology fee on cleared transactions to cover instant UPI payment gateway charges, automated shoot contract generation, server storage, and neutral dispute mediation.
                    </p>
                  </section>
                </article>
              )}
              ...
              {activeSection === 'escrow' && (
                <article className="legal-article">
                  ...
                  <p className="lead-text">
                    Camqrew operates an automated milestone escrow engine engineered specifically for media and production workflows to guarantee complete payment security for both clients and creators.
                  </p>
                  ...
                  <div className="escrow-breakdown-card">
                    ...
                    <div className="escrow-tier-item">
                      ...
                      <p>Released upon delivery of high-resolution master video edits, RAW photo archives, or graded assets via Camqrew Cloud Drive within the agreed turnaround schedule.</p>
                    </div>
                  </div>
              ...
              {activeSection === 'copyright' && (
                <article className="legal-article">
                  ...
                  <section className="legal-section">
                    ...
                    <p>
                      The Specialist retains non-exclusive rights to showcase excerpt clips, behind-the-scenes photographs, and finished video reels on their Camqrew public profile, personal showreel, and creative portfolio, unless an explicit Non-Disclosure Agreement (NDA) was booked.
                    </p>
                  </section>
                </article>
              )}
              ...
              {activeSection === 'rentals' && (
                <article className="legal-article">
                  ...
                  <section className="legal-section">
                    ...
                    <p>
                      All gear rentals require a refundable security deposit held in Camqrew Escrow. The deposit is automatically released back to the renter within 24 hours of equipment return and physical inspection.
                    </p>
                  </section>
                ...
                <article className="legal-article">
                  ...
                  <section className="legal-section">
                    ...
                    <div className="grievance-officer-card">
                      ...
                      <p>Designation: Head of Trust & Safety, Camqrew India</p>
                      <p>Email: grievance@camqrew.in / legal@camqrew.in</p>
                      <p>Address: Camqrew Studios, Bandra West, Mumbai, Maharashtra 400050</p>
                    </div>
                  </section>
                </article>
              )}
              ...
              {activeSection === 'deletion' && (
                <article className="legal-article">
                  ...
                  <p className="lead-text">
                    In compliance with Apple App Store Guideline 5.1.1(v), Google Play User Data Policy, and the DPDP Act 2023, Camqrew provides immediate in-app and web self-service account deletion.
                  </p>
